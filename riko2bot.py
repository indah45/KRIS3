...
import RIKO2SELFBOT
from RIKO2SELFBOT.lib.curve.ttypes import *
...
cl = RIKO2SELFBOT.LINE()
cl.login(token="Epg0PKLVXp23Ext1cXfb.679z21SPpEhcWEDDQRkw2W.Bmp3tT+2xGvF8WjZh7jkPJ+zGPgbxFprbLu6xtTDs58=")
cl.loginResult()
...
║☞ [Talklist]
╠═════════════════
╠❂͜͡➣ ❁R̯̙̱͇̗̼̉̎͊̇̎̕͟͟͡I̛̮̝̖̾͌͂̄̈́̍̅̅̄͜͜K̨͎̺͚̘̻̬̱̲̉͒̅̽̾͝Ǫ̷̛͉̙͖͈̯̙͓͍̋͑̐̕͘͢͝͞ S̶̙̯̺̤̠̦̻̃̆͆̽͒̏͌̅͛͢E̡̨̡͕͇̲̼̐̾̆̓̐̄̒̽͝L̮͖͍̭̗̅̑́͆͒̔̈͢͠͞F̵̣̱̪͓̙̀̀̐̅̌̂͘̚͟͜͝͞B̴̛̝̳̱̬̙̓̅̈́̿̿̚͢O̠̺̙͇̫̹̘͕̅̑̇̏̚͞͠Ṫ̵͉͚̱͖̰̉̏̊̉̓̆̇͟͜͠ ❁ 
╠═════════════════
╠❂͜͡➣ OWNER: https://line.me/ti/p/~riko_arkeda
║ ➡➡➡@(􀠁􀠁☆─┅═ই╬ ❥T҉̶̘̟̼̉̈́͐͋͌̊Σ̶Δ̶M҉̶̘͈̺̪͓̺ͩ͂̾ͪ̀̋ ̶̶̶N̶O̸͟͞O̶̶͓̽B̸͟͞ β̶Ω̶T҉̶̘̟̼̉̈́͐͋͌̊ ☆)(2 s ⬅⬅⬅
╚═════════════════"""
...
Bots=[mid,"uebbf59db5b293de1c2c1e75daab296db"]
admin=["uebbf59db5b293de1c2c1e75daab296db","uf15f63d71ad0162c3e791cd3c6efca96"]
owner=["uebbf59db5b293de1c2c1e75daab296db","uf15f63d71ad0162c3e791cd3c6efca96"]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Add My Creator http://line.me/ti/p/~riko_arkeda",
    "lang":"JP",
    "comment":"",
...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
    try:
        cl.sendText(op.param1, cl.getContact(op.param2).displayName + " Jangan kick sembarangan 😑")
    except Exception as e:
        print e
...
def bot(op):
    try:
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        if len(G.members) <= wait["autoCancel"]["members"]:
                            ...
                            cl.sendText(op.param1,"Thnx For Invite Me Your Group 😊")
                    else:
                        cl.acceptGroupInvitation(op.param1)
                        cl.sendText(op.param1,"Thnx For Invite Me Your Group 😊")
        ...
        if op.type == 26:
            msg = op.message            
            if msg.text in ["Mayhem","mayhem","Nuke","nuke","Greet","greet","Ratakan","ratakan","Ready op","ready op","Cleanse","cleanse","Kickall","kickall",".kickall"]:
              dia = ("Tercyduck Kamu Yah Mau Anu 😆","Mau Ngapain? ┌П┐(◣_◢)┌П┐ ")
              ket = random.choice(dia)
              cl.sendText(msg.to,ket)
              cl.kickoutFromGroup(msg.to,[msg.from_])
              cl.sendText(msg.to,"Mampus Lu Kekick 😎")                            
        if op.type == 26:
            msg = op.message            
        ...
        if op.type == 26:
            ...
            if wait["crashpc"] == True:
                if msg.toType == 0:
                    cl.sendChatChecked(msg.from_,msg.id)
                    cl.sendText(msg.from_,"「Dont Chat Me!! 」")
                    msg.contentType = 13
...
#----------------ABOUT SECTION----------#
               ...
               if msg.from_ in admin:
                cl.sendText(msg.to,"「Aʙᴏᴜᴛ Bᴏᴛ」\nR̯̙̱͇̗̼̉̎͊̇̎̕͟͟͡I̛̮̝̖̾͌͂̄̈́̍̅̅̄͜͜K̨͎̺͚̘̻̬̱̲̉͒̅̽̾͝Ǫ̷̛͉̙͖͈̯̙͓͍̋͑̐̕͘͢͝͞ S̶̙̯̺̤̠̦̻̃̆͆̽͒̏͌̅͛͢E̡̨̡͕͇̲̼̐̾̆̓̐̄̒̽͝L̮͖͍̭̗̅̑́͆͒̔̈͢͠͞F̵̣̱̪͓̙̀̀̐̅̌̂͘̚͟͜͝͞B̴̛̝̳̱̬̙̓̅̈́̿̿̚͢O̠̺̙͇̫̹̘͕̅̑̇̏̚͞͠Ṫ̵͉͚̱͖̰̉̏̊̉̓̆̇͟͜͠  Eᴅɪᴛɪᴏɴ♪\nTɪᴍᴇ: " + datetime.today().strftime('%H:%M:%S') + " \n\n「Bᴏᴛ Iɴғᴏʀᴍᴀᴛɪᴏɴ」\n╠═════════════════════\n ☸ Bᴏᴛ Cʀᴇᴀᴛᴏʀ: "+cl.getProfile().displayName+"\n  ☸ Bᴏᴛ Tʏᴘᴇ: Sᴇʟғʙᴏᴛ\n  ☸ Vᴇʀsɪᴏɴ: 4.0\n╠═════════════════════\n「Cᴏɴᴛᴀᴄᴛ Pᴇʀsᴏɴᴀʟ」\n「 ▶️ ID LINE: line://ti/p/~riko_arkeda 」\n\nR̯̙̱͇̗̼̉̎͊̇̎̕͟͟͡I̛̮̝̖̾͌͂̄̈́̍̅̅̄͜͜K̨͎̺͚̘̻̬̱̲̉͒̅̽̾͝Ǫ̷̛͉̙͖͈̯̙͓͍̋͑̐̕͘͢͝͞ S̶̙̯̺̤̠̦̻̃̆͆̽͒̏͌̅͛͢E̡̨̡͕͇̲̼̐̾̆̓̐̄̒̽͝L̮͖͍̭̗̅̑́͆͒̔̈͢͠͞F̵̣̱̪͓̙̀̀̐̅̌̂͘̚͟͜͝͞B̴̛̝̳̱̬̙̓̅̈́̿̿̚͢O̠̺̙͇̫̹̘͕̅̑̇̏̚͞͠Ṫ̵͉͚̱͖̰̉̏̊̉̓̆̇͟͜͠  ")
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
...
#==============================================================================#                                                                                  
              ...
              if msg.from_ in admin:
               ...
               if msg.from_ in admin and owner:           	
                msg.contentType = 13
                msg.contentMetadata = {'mid': "uc4670540ac3b113403a9667df0b09df3',"}
                cl.sendText(msg.to,"Sepi ea ┌П┐(◣_◢)┌П┐")
                cl.sendMessage(msg)
              ...
              if msg.from_ in admin:
            	...
            	cl.sendText(msg.to,"Me Key Saat Ini Adalah : 「"+wait["me"]+"」")
                ...
                wait["me"] = "me"
                cl.sendText(msg.to,"Me Key Berhasil Direset Menjadi : 「"+wait["me"]+"」")
                
            elif msg.text.lower() == "respon key":
            	cl.sendText(msg.to,"Respon Key Saat Ini Adalah : 「"+wait["AgResp"]+"」")
            elif "Set respon: " in msg.text:
                wait["AgResp"] = msg.text.replace("Set respon: ","")
                cl.sendText(msg.to,"Respon Key Berhasil Diubah Menjadi : 「"+wait["AgResp"]+"」")
            elif msg.text in ["Reset respon key"]:
                wait["AgResp"] = "AgResp"
                cl.sendText(msg.to,"Respon Key Berhasil Direset Menjadi : 「"+wait["AgResp"]+"」")
                
            elif msg.text.lower() == "respontag key":
            	cl.sendText(msg.to,"Respon Tag Key Saat Ini Adalah : 「"+wait["TagRespon"]+"」")
            elif "Set respontag: " in msg.text:
                wait["TagRespon"] = msg.text.replace("Set respontag: ","")
                cl.sendText(msg.to,"Respon Tag Key Berhasil Diubah Menjadi : 「"+wait["TagRespon"]+"」")
            elif msg.text in ["Reset respontag key"]:
                wait["TagRespon"] = "TagRespon"
                cl.sendText(msg.to,"Respon Tag Key Berhasil Direset Menjadi : 「"+wait["TagRespon"]+"」")
...
#==============================================================================#
                ...
                cl.sendText(msg.to,"「 Detect Mention」\nType: Respon Group\nStatus: On Success\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                wait["respondpc"] = True
                cl.sendText(msg.to,"「 Auto Respon Pc」\nType: Respon Pc\nStatus: On Success\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                wait["crashpc"] = True
                cl.sendText(msg.to,"「 Auto Respon Pc + Crash」\nType: Respon Pc + Crash\nStatus: On Success\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                wait["crashTag"] = True
                cl.sendText(msg.to,"「 Mention Crash」\nType: Respon Group\nStatus: On Success\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["tagMention"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"「 Tag Mention」\nType: Respon Group\nStatus: On Success\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"Tag Mention Set to ON")
                else:
                    wait["TagMention"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"「 Tag Mention」\nType: Respon Group\nStatus: On Success\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"Tag Mention Already ON")
                ...
                if wait["TagMention"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Tag Mention Set to OFF")
                else:
                    wait["TagMention"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"「 Tag Mention」\nType: Respon Group\nStatus: Off Success\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"Tag Mention Already OFF")
                ...
                cl.sendText(msg.to,"「 Block Mention」\nType: Respon Group\nStatus: On Success\n\n"+ datetime.today().strftime('%H:%M:%S'))
...
#==============================================================================#
                ...
                cl.sendImage(msg.to, "hilihkinthil.png")
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        msg.contentMetadata={'PRDID': '89131c1a-e549-4bd5-9e60-e24de0d2e252',
                                    ...
                                    'MSGTPL': '10'}
                        msg.text = None
                        cl.sendText(msg.to,"Check Your Gift 😆")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendMessage(msg.to,"Grup Cleanse")
#-----------------------------------------------------
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendMessage(msg.to,"Grup Dibersihkan")
#-----------------------------------------------------------
...
#	      if msg.from_ in Creator:
            ...
            elif "Tag:55 @" in msg.text:
                _name = msg.text.replace("Tag:55 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "Tag:60 @" in msg.text:
                _name = msg.text.replace("Tag:60 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "Tag:65 @" in msg.text:
                _name = msg.text.replace("Tag:65 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "Tag:70 @" in msg.text:
                _name = msg.text.replace("Tag:70 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "Tag:75 @" in msg.text:
                _name = msg.text.replace("Tag:75 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "Tag:80 @" in msg.text:
                _name = msg.text.replace("Tag:80 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "Tag:85 @" in msg.text:
                _name = msg.text.replace("Tag:85 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "Tag:90 @" in msg.text:
                _name = msg.text.replace("Tag:90 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "Tag:95 @" in msg.text:
                _name = msg.text.replace("Tag:95 @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
...
#==============================================================================#
                ...
                if False:
                 	cl.sendText(msg.to,"Gaada ID kayak gitu goblok!")
                if True:
                    msg.contentType = 13
...
#----------------------------------------------
                ...
                try:
                    if msg.toType == 2:
                        cl.kickoutFromGroup(msg.to,[msg.from_])
                        cl.sendText(msg.from_,"Hati Hati Kalo Ngomong (｀・ω・´)")
                except:
                    pass
#========================================
               ...
               if msg.toType == 2:
                ...
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
                jawab = ("Bot Creator by Riko","My Creator is Handsome","My Creator is Cool")
                jawaban = random.choice(jawab)
...
#-----------------------[Bot speed test Section]------------------------
                ...
                if msg.from_ in owner or staff:
                    ...
                    cl.sendText(msg.to, "「Response Protect」")
                    start = time.time()
                    for i in range(3000):
                        1+1
                    elsp = time.time() - start
                    cl.sendText(msg.to,"「%sseconds」" % (elsp))     
                    print "[Command]Speed Response Protect"                    
 
                    cl.sendText(msg.to, "「Response Invite」")                    
                    start2 = time.time()
                    for i in range(3000):
                        1+1
                    elsp2 = time.time() - start2
                    cl.sendText(msg.to,"「%sseconds」" % (elsp2))     
                    print "[Command]Speed Response Invite"                  
                    
                    cl.sendText(msg.to, "「Response Cancel」")                    
                    start3 = time.time()
                    for i in range(3000):
                        1+1
                    elsp3 = time.time() - start3
                    cl.sendText(msg.to,"「%sseconds」" % (elsp3))       
                    print "[Command]Speed Response Cancel"                
                    
                    cl.sendText(msg.to, "「Response Kick」")                    
                    start4 = time.time()
                    for i in range(3000):
                        1+1
                    elsp4 = time.time() - start4
                    cl.sendText(msg.to,"「%sseconds」" % (elsp4))       
                    print "[Command]Speed Response Kick"        
                    
                    cl.sendText(msg.to, "「Response Qr」")                    
                    start5 = time.time()
                    for i in range(3000):
                        1+1
                    elsp5 = time.time() - start5
                    cl.sendText(msg.to,"「%sseconds」" % (elsp5))    
                    print "[Command]Speed Response Qr"       

                    cl.sendText(msg.to, "=====「Response Done! 」=====")
...
#-----------------------------------------------
                ...
                displayfreand = cl.getContacts(wait["talkblacklist"])
                cl.sendText(msg.to, "Please wait...")
                num=1
...
#-----------------------------------------------
        ...
        if op.type == 15:
            if wait["Lv"] == True:
                if op.param2 in Bots:
                    return
                cl.sendText(op.param1, "╔═════════════" + "\n║" + cl.getContact(op.param2).displayName + "\n╠═════════════\n║Selamat Jalan Kakak Terima Kasih Telah Berbelanja Di Indomaret 😊 \n╚═════════════")
