...
import RIZKYSELFBOT
from RIZKYSELFBOT.lib.curve.ttypes import *
...
cl = RIZKYSELFBOT.LINE()
cl.login(token="EpTIpteN6C45LgfLkii6.GAY34ELKbJ3dZ77ay9iRXG.uC5vj85NN79n28PZp48steT2bqc/9akfCf036g4sBBE=")
cl.loginResult()
...
║☞ [Talklist]
╠═════════════════════
╠❂͜͡➣ ❁Ȑ̴̛͓̰̫̹̮͚̍͌̍̋I̗̼̜͙̘͖̺̿̌̈̔͊͗̀͟͟͡Ẕ̵̧̨̳̼͙̓͆̆͋̓́͜͟Ÿ̶̩̘͎̯͉͈̥͐̿͒̊ͅ R̴̢͙̩͈̼̥͈̞̲̈́̏̀̾͋A̶͕̟̙̗͓̝̎̑̋̎̄Ḧ̶̡͇̱͙̯̺̫̠̝̀̉̔͋͌͌̋̈́̕M̡̪̘͎̭̟̜̲͓̃̈̌̎̄̓̄̚̕Ȧ̶͔̜͕̱͖̪̲̳͐̋̅̇͒̇͜D̸̡̠̩͈̓̏͆̂͆̅͜ S͓̲̬̥͖̱̣̀̀̕͠͞Ẽ̶͇̪̰̑̑̂̄͜͜Ļ̳͖̦̬̹̥̥̾͆̄̏͂̈͆͢͢F̷̨̢̠͕̩̭̱͐͐͑͒̑͐͘͢B̵̢̗̲̝̗͙͒̆͐̍͐̒̽̍̀͠Ó̧̠̜̗̪͇̳̻̯̤̒͐̓̒̍̚Ţ̡̭̞̖̦͉̪̩̣̑͆̒̔̅̇͒͋❁ 
╠═════════════════════
╠❂͜͡➣ OWNER: https://line.me/ti/p/~rizky361
...
Bots=[mid,"u81acb7e1e964063dc3cfbec063d22bc6"]
admin=["u81acb7e1e964063dc3cfbec063d22bc6","uebbf59db5b293de1c2c1e75daab296db","uf15f63d71ad0162c3e791cd3c6efca96"]
owner=["u81acb7e1e964063dc3cfbec063d22bc6","uf15f63d71ad0162c3e791cd3c6efca96"]
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        if len(G.members) <= wait["autoCancel"]["members"]:
                            ...
                            cl.sendText(op.param1,"Thanx For Invited Me Your Group 😊")
                    else:
                        cl.acceptGroupInvitation(op.param1)
                        cl.sendText(op.param1,"Thanx For Invited Me Your Group 😊")
        ...
        if op.type == 26:
            ...
            if wait["respondpc"] == True:
                if msg.toType == 0:                	
                    ...
                    balas = ["Halo 「" + cName + "」\nMohon Maaf Rizky Rahmad Sedang Sibuk, Ini Adalah Pesan Otomatis, Jika Ada Yang Penting Mohon Hubungi Rizky Rahmad Nanti, Terimakasih."]
            ...
            if "MENTION" in msg.contentMetadata.keys() != None:
                 if wait['detectMention'] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy ",cName + " Ngapain Ngetag?, ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja ", cName + " Kenapa Tag saya? ","┌П┐(◣_◢)┌П┐ " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?",cName + " ┌П┐(◣_◢)┌П┐"]
...
#-----------------------[Admin add section]------------------------
              ...
              if admin == []:
                  ...
                  mc = "||Admin ❁Ȑ̴̛͓̰̫̹̮͚̍͌̍̋I̗̼̜͙̘͖̺̿̌̈̔͊͗̀͟͟͡Ẕ̵̧̨̳̼͙̓͆̆͋̓́͜͟Ÿ̶̩̘͎̯͉͈̥͐̿͒̊ͅ R̴̢͙̩͈̼̥͈̞̲̈́̏̀̾͋A̶͕̟̙̗͓̝̎̑̋̎̄Ḧ̶̡͇̱͙̯̺̫̠̝̀̉̔͋͌͌̋̈́̕M̡̪̘͎̭̟̜̲͓̃̈̌̎̄̓̄̚̕Ȧ̶͔̜͕̱͖̪̲̳͐̋̅̇͒̇͜D̸̡̠̩͈̓̏͆̂͆̅͜ S͓̲̬̥͖̱̣̀̀̕͠͞Ẽ̶͇̪̰̑̑̂̄͜͜Ļ̳͖̦̬̹̥̥̾͆̄̏͂̈͆͢͢F̷̨̢̠͕̩̭̱͐͐͑͒̑͐͘͢B̵̢̗̲̝̗͙͒̆͐̍͐̒̽̍̀͠Ó̧̠̜̗̪͇̳̻̯̤̒͐̓̒̍̚Ţ̡̭̞̖̦͉̪̩̣̑͆̒̔̅̇͒͋❁  ||\n=====================\n"
                  for mi_d in admin:
